...
class GoogleMapDownloader:
    ...
    def generateImage(self, **kwargs):
        """
            Generates an image by stitching a number of google map tiles
            together.
...
def main():
    ...
    try:
        ...
        print("""Could not generate the image - try adjusting the zoom level
                 and checking your coordinates""")
    else:
        # Save the image to disk
        path = "/home/pawel/3city-transport/src/state/"
        img.save(os.path.join(path, "high_resolution_image.png"))
